			...
			<div class="intro cointaner">
				<div class="intro-content">
					...
					<div class="btns-wizard">
						<a class="wizard" href="<?php echo esc_url( admin_url( 'themes.php?page=travelvacation-wizard' ) ); ?>"target="_blank" class="button button-primary"><?php esc_html_e( 'One Click Demo Setup', 'travel-vacation' ); ?></a>
					</div>
				</div>
				<div class="intro-img">
