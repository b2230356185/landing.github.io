...
<div id="help-panel" class="panel-left visible">
    <div id="#help-panel" class="steps">  
        <h4 class="cc">
            <?php esc_html_e( 'Quick Setup for Home Page', 'travel-vacation' ); ?>
            <a href="<?php echo esc_url( 'https://demo.asterthemes.com/docs/travel-vacation-free' ); ?>" class="button button-primary" style="margin-left: 5px; margin-right: 10px;" target="_blank"><?php esc_html_e( 'Free Documentation', 'travel-vacation' ); ?></a>
        </h4>
        <hr class="quick-set">
        ...
        <hr>
        <h4><?php esc_html_e( 'Setup Banner Section', 'travel-vacation' ); ?></h4>
        <hr class="quick-set">
