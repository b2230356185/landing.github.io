        ...
        <?php
			...
			if (!empty($travel_vacation_embeds)) {
			    ...
			    foreach ($travel_vacation_embeds as $travel_vacation_embed) {
			        ...
			        if (strpos($travel_vacation_embed, 'video') !== false || strpos($travel_vacation_embed, 'youtube') !== false || strpos($travel_vacation_embed, 'vimeo') !== false || strpos($travel_vacation_embed, 'dailymotion') !== false || strpos($travel_vacation_embed, 'vine') !== false || strpos($travel_vacation_embed, 'wordPress.tv') !== false || strpos($travel_vacation_embed, 'hulu') !== false) {
			            ?>
