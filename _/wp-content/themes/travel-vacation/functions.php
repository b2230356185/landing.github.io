...
function travel_vacation_scripts() {
	...
	// RTL style.
	wp_style_add_data('travel-vacation-style', 'rtl', 'replace');
...
add_filter( 'loop_shop_per_page', 'travel_vacation_products_per_page' );
function travel_vacation_products_per_page( $cols ) {
  	return  get_theme_mod( 'travel_vacation_products_per_page',9);
}

// Change number or products per row 
add_filter('loop_shop_columns', 'travel_vacation_loop_columns');
	if (!function_exists('travel_vacation_loop_columns')) {
	function travel_vacation_loop_columns() {
		return get_theme_mod( 'travel_vacation_products_per_row', 3 );
	}
}
...
function travel_vacation_customizer_live_preview() {
    wp_enqueue_script(
        'travel-vacation-customizer',
...
add_action('customize_preview_init', 'travel_vacation_customizer_live_preview');