...
$travel_vacation_pg_404_image      = get_theme_mod('travel_vacation_pg_404_image','');
?>
<section class="not-found">
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-12">
                <?php if (!empty($travel_vacation_pg_404_image)) : ?>
                    <img src="<?php echo esc_url($travel_vacation_pg_404_image); ?>" alt="<?php echo esc_attr($travel_vacation_pg_404_ttl); ?>" class="img-fluid">
                <?php else : ?>
